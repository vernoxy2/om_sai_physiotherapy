  ...
  const faqs = [
    {
      ...
      answer: (
        <>
          ...
          university, the physiotherapy program is either a master’s or
          doctorate level degree. Physiotherapists have years of
          university-level training in anatomy, physiology, kinesiology (the
          study of joint movement), neurology, and many of the other medical
          sciences. You’re in good hands!
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <>
          We suggest that you bring in the following items when you come for
          your first visit:
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            We accept all insurance companies. If you do not have insurance,
            cash or credit card options are available.
          </p>
          <p className="mt-3">
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          primary health care providers and an appointment can be booked without
          a doctor’s prescription. However,
          <br />
          if you are utilizing your extended health care to pay for your
          sessions certain providers request a doctor’s referral in order to
          reimburse you for treatment provided. Therefore, it is important to
          first check with your extended health care provider for the specific
          requirements of your plan prior to booking a physiotherapy assessment
          to ensure reimbursement of payment.
        </>
      ),
    },
  ];
