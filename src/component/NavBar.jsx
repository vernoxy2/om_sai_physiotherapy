...
//       { id: 44, name: "Shockwave Therapy", url: "/services/shockwave-therapy" },
//       { id: 45, name: "Acupuncture Treatment", url: "/services/acupuncture-treatment" },
//     ],
//   },
...
//     // ✅ CLOSE DESKTOP DROPDOWN AFTER SUBMENU CLICK
//     setDesktopDropdown(null);
//     setDesktopSticky(null);
...
//           <ul
//             ref={desktopRef}
//             className="hidden md:flex space-x-4 lg:space-x-8 relative h-full gap-5"
//           >
//             {menuItems.map((link) => {
...
//                   <button
//                     onClick={() => {
//                       handleMainClick(link.id, hasSubmenu);
...
//                                 }
//                                 className={`block py-1 text-base w-full px-3 transition-colors duration-200 ${
//                                   isActiveSub
//                                     ? "text-primary font-bold"
//                                     : "text-[#696969] hover:text-primary"
//                                 }`}
...
//       {menuOpen && (
//         <div className="md:hidden bg-white w-full rounded-3xl border border-gray-300 text-[#696969] shadow-xl mt-1">
...
//                     }}
//                     className={`w-full flex justify-center items-center gap-2 text-base transition-colors duration-200 ${
//                       isMainActive
//                         ? "text-primary font-bold"
//                         : "text-[#696969] hover:text-primary"
//                     }`}
...
//                                 handleSubmenuClick(sub.id, link.id)
//                               }
//                               className={`w-full flex justify-center items-center gap-1 text-base transition-colors duration-200 ${
//                                 isActiveSub
//                                   ? "text-primary font-bold"
//                                   : "text-[#696969] hover:text-primary"
//                               }`}
